package com.goortis.pedidos.test;
...
import com.goortis.pedidos.PedidosApplication;
...
import com.goortis.pedidos.domain.PedidoBuilder;
...
public class PedidoApplicationTests {
	...
	assertEquals(Double.valueOf(120), pedidoVenda.getTotal());
    }
	...
	assertEquals(Double.valueOf(294.50), pedidoVenda.getTotal());
    }
	...
	assertEquals(Double.valueOf(423), pedidoVenda.getTotal());
    }
	...
	assertEquals(Integer.valueOf(1), pedidoVenda.getItemsPedidos().get(0).getQuantidade());
    }
	...
	pedido1.setItemsPedidos(new ArrayList<ItemPedido>());
	...
	Optional<Pedido> pedido1 = pedidoService.buscar(999L);
